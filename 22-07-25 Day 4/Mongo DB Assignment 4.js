...
db.sessions.insertMany([
  { session_id: 201, member_id: 1, trainer_id: 101, session_type: "Strength", duration: 60, date: "2024-08-01" },
  { session_id: 202, member_id: 2, trainer_id: 102, session_type: "Cardio", duration: 45, date: "2024-08-02" },
  { session_id: 203, member_id: 3, trainer_id: 103, session_type: "Yoga", duration: 90, date: "2024-08-03" },
  { session_id: 204, member_id: 1, trainer_id: 102, session_type: "Cardio", duration: 30, date: "2024-08-04" },
  { session_id: 205, member_id: 4, trainer_id: 101, session_type: "Strength", duration: 75, date: "2024-08-05" },
  { session_id: 206, member_id: 5, trainer_id: 103, session_type: "Yoga", duration: 60, date: "2024-08-05" }
])
...
db.sessions.aggregate([ { $match: { duration: {$gt: 60}}},
                        { $lookup: {
                          from: "members",
                          localField: "member_id",
                          foreignField: "member_id",
...
db.members.insertOne({ member_id: 6, name: "Karan Singh", age: 27, gender: "Male", city: "Chennai", membership_type: "Gold"})
